                        ...
                        <div className={ style.colmun }>
                            <div className={ style.teamcol }>
                                <div className={ style.teamcolinner }>
                                    ...
                                    <div className={ style.member - info }><p align="center">The term pizza was first recorded in the 10th century in a Latin manuscript from the Southern Italian town.</p></div>
                        ...
                        <div className={ style.colmun }>
                            <div className={ style.teamcol }>
                                <div className={ style.teamcolinner }>
                                    ...
                                    <div className={ style.member - info }><p align="center">A burger is a flat round mass of minced meat or vegetables, which is fried and often eaten in a bread roll.</p></div>
                        ...
                        <div className={ style.colmun }>
                            <div className={ style.teamcol }>
                                <div className={ style.teamcolinner }>
                                    ...
                                    <div className={ style.member - info }><p align="center">Subway was founded by Fred DeLuca and financed by Peter Buck in 1965 as Pete's Super Submarines in Bridgeport.</p></div>
                                    <div className={ style.member - mail }> <p align="center"> <a href="mailto:@gmail.com">Burger12@gmail.com</a> </p> </div><br />
                                    <div className={ style.button }><button>Order now</button></div> <br />
                                </div>
                            </div>
                        ...
                        <div className={ style.colmun }>
                            <div className={ style.teamcol }>
                                <div className={ style.teamcolinner }>
                                    ...
                                    <div className={ style.member - info }><p align="center">A sizzler is a medley dish invented in Mumbai. It is cooked and served on a hot metal plate that is placed.</p></div>
                                    <div className={ style.member - mail }> <p align="center"> <a href="mailto:@gmail.com">Sendwich12@gmail.com</a> </p> </div><br />
                                    <div className={ style.button }><button>Order now</button></div><br />
                                </div>
                            </div>
